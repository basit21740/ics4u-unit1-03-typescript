...
try {
  // Input
  console.log("Enter the food you would like cooked (pizza, sub or soup): "
  function input(foodChosen:any){
var foodChosenUpperCase = foodChosen.toUpperCase();
    console.log();
console.log("Enter how many items you would like to be cooked): "
 function saveInput(numberOfItems:any) {
 console.log();
 // Process and outputs
